job('Java Maven App DSL 3') {
    ...
    scm {
        git('https://github.com/JuanBritog/simple-java-maven-app.git', 'master') { node ->
            node / gitConfigName('JuanBritog')
            node / gitConfigEmail('brito.grandes@gmail.com')
        }
    }
    triggers {
    	githubPush()
